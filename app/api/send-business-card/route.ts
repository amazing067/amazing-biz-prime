...
export async function POST(request: NextRequest) {
  try {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="margin-top: 20px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              <td style="padding: 8px; border-bottom: 1px solid #e2e8f0; font-weight: bold;">팩스번호</td>
              <td style="padding: 8px; border-bottom: 1px solid #e2e8f0;">${body.fax}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 8px; border-bottom: 1px solid #e2e8f0;">${body.address}</td>
            </tr>
          </table>
        </div>

        <div style="margin-top: 30px;">
          <h3 style="color: #334155; margin-bottom: 15px;">명함 정보</h3>
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 8px; border-bottom: 1px solid #e2e8f0; font-weight: bold; width: 120px;">디자인</td>
              <td style="padding: 8px; border-bottom: 1px solid #e2e8f0;">${body.orientation}</td>
            </tr>
            <tr>
              <td style="padding: 8px; border-bottom: 1px solid #e2e8f0; font-weight: bold;">선택사항</td>
        ...
        <div style="margin-top: 30px;">
          <h3 style="color: #334155; margin-bottom: 15px;">특이사항</h3>
          <p style="padding: 15px; background-color: #f8fafc; border-radius: 8px; color: #475569;">
            ${body.memo || "없음"}
          </p>
        </div>
    ...
    await transporter.sendMail({
      from: `"명함 신청 시스템" <${emailUser}>`,
      to: "induo@naver.com",
      replyTo: body.email,
      subject: body.subject || `[명함신청] ${body.name}님의 명함 신청서`,
      html: htmlContent,
    });
